            ...
            <div class="container">
                        <div class="row justify-content-center">
                                    <div class="col-md-8 bg-light p-5 rounded mt-5">
                                      ...
                                      <form  action="{{url('/addmrt')}}"  method="POST" id="form-data" enctype="multipart/form-data" files="true">
                                        @csrf
                                                        <div class="form-row">
                                                          <div class="col-md-6 mb-3">
                                                            <label for="validationTooltip01">ชื่อสถานี MRT</label>
                                                            <input type="text" name="mrt"  class="form-control" required>
                                                          </div>
